...
`add-child` takes the **goal** (3rd arg) and the **depends_on DAG edge** (4th arg,
...
Need to fix a stub after the fact (re-word a goal, add/adjust the DAG edge)? Use
...
## Verify before you finish (do NOT claim a DAG you didn't write)
