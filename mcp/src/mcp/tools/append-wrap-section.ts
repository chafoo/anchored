...
export const appendWrapSectionTool: AnchoredTool = {
  name: 'task__append_wrap_section',
  description:
    'Append markdown to a named subsection under context.wrap.subsections. Creates the subsection if absent; whitespace-only content is a no-op.',
